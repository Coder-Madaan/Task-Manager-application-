          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <input
                ...
                type="password"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-dark-300 bg-dark-200 placeholder-gray-500 text-gray-200 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
